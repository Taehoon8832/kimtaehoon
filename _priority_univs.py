...
PRIORITY = [
    ...
    {"key": "연세대", "match": ["연세대(서울)"], "exclude": [], "board": "https://admission.yonsei.ac.kr/seoul/admission/html/counsel/notice.asp", "home": "https://admission.yonsei.ac.kr/seoul/admission/html/main/main.asp"},
    {"key": "고려대", "match": ["고려대(안암)"], "exclude": [], "board": "https://oku.korea.ac.kr/oku/cms/FR_CON/index.do?MENU_ID=590", "home": "http://oku.korea.ac.kr/"},
    {"key": "서강대", "match": ["서강대"], "exclude": [], "board": "https://admission.sogang.ac.kr/enter/html/counsel/notice.asp", "home": "https://admission.sogang.ac.kr/enter/html/main/index.asp"},
    {"key": "성균관대", "match": ["성균관대"], "exclude": [], "board": "https://admission.skku.edu/admission/html/ipsi/notice.html", "home": "https://admission.skku.edu/admission/html/main/main.html"},
    {"key": "한양대", "match": ["한양대(서울)"], "exclude": [], "board": "https://go.hanyang.ac.kr/web/notice/notice_list.do?m_type=IPSI", "home": "https://go.hanyang.ac.kr/gate.do"},
    ...
    {"key": "이화여대", "match": ["이화여대"], "exclude": [], "board": "https://admission.ewha.ac.kr/admission/html/ewharo/notice.asp", "home": "https://admission.ewha.ac.kr/admission/html/main/intro.asp"},
    {"key": "숙명여대", "match": ["숙명여대"], "exclude": [], "board": "https://admission.sookmyung.ac.kr/admission/html/counsel/notice.asp", "home": "https://admission.sookmyung.ac.kr/admission/html/main/main.asp"},
    {"key": "숭실대", "match": ["숭실대"], "exclude": [], "board": "https://iphak.ssu.ac.kr/board/notice_list.asp?page=1&page_no=1_1_1", "home": "https://iphak.ssu.ac.kr/"},
    {"key": "국민대", "match": ["국민대"], "exclude": [], "board": "https://admission.kookmin.ac.kr/nonschedule/notice.php", "home": "https://admission.kookmin.ac.kr/main.php"},
    ...
    {"key": "인하대", "match": ["인하대"], "exclude": [], "board": "https://admission.inha.ac.kr/cms/FR_CON/index.do?MENU_ID=240", "home": "https://admission.inha.ac.kr/index.do"},
    {"key": "경기대", "match": ["경기대(서울)", "경기대(수원)"], "exclude": [], "board": "https://enter.kyonggi.ac.kr/cms/FR_CON/index.do?MENU_ID=210", "home": "https://enter.kyonggi.ac.kr/index.do"},
